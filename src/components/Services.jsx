    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Brainwave unlocks the potential of AI-Powered apps"
        />
          ...
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto ">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlocks the potential of AI power apps.
              </p>
              <ul className="body-2">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your designs using AI app&apos;s. Our
                  AI-powered photo editing tool is designed to help you create
                  stunning visuals.
                </p>
              </div>
